...
init = function(){
	...
	tl	
	.set("#main_group", {scale:1.1})
	.to("#main_group", 2, {ease:Power2.easeInOut, x:-11, y:110, scale:0.8}, "+=0.4")
	.to("#monster1", 1, {ease:Power2.easeInOut, x:-85}, "-=1.6")
	.to("#monster2", 1, {ease:Power2.easeInOut, x:-143}, "-=1.6")
